...
- **Fosun DeepSeek ** focuses on providing an intuitive and responsive web interface for chat interactions.
- **Ollama** is the underlying technology that powers these interactions.

If your issue or contribution pertains directly to the core Ollama technology, please direct it to the appropriate [Ollama project repository](https://ollama.com/). Fosun DeepSeek 's repository is dedicated to the web interface aspect only.
...
Your contributions, big or small, make a significant impact on Fosun DeepSeek . We're excited to see what you bring to the project!
